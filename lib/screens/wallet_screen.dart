    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        return Scaffold(
          ...
          bottomNavigationBar: const _MainNav(selectedIndex: 3),
        );
      },
    );
  }
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(transaction.icon, color: const Color(0xFF111827)),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('FNB', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
                  SizedBox(height: 2),
          ...
          Spacer(),
          Text('****  -  ****  -  ****  -  **68', style: TextStyle(color: Color(0xFFDFE3EA))),
        ],
      ),
    );
  }
